...
const typeConfig = {
  charge: { icon: ArrowUpCircle, label: '충전', color: 'text-accent-foreground' },
  ...
  <div className="min-h-screen bg-background">
    <div className="gradient-sage safe-top">
      <div className="page-header-gradient pt-4">
        ...
        <p className="text-xs opacity-70">보유 포인트</p>
      </div>
    </div>
          ...
          <Card key={tx.id} className="glass-card">
            <CardContent className="flex items-center gap-3 p-4">
              ...
              <div className="text-right shrink-0">
                <p className={`font-bold text-sm ${tx.amount > 0 ? 'text-accent-foreground' : 'text-rose'}`}>
